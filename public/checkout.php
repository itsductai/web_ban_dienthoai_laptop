...
if (!isset($_SESSION['user_id'])) {
    // Chuyển hướng người dùng về trang cart
    echo '<script>
    if (confirm("Bạn cần đăng nhập để thanh toán.")) {
        window.location.href = "login.php"; // Chuyển hướng người dùng về trang cart
    } else {
        window.history.back(); // Quay lại trang trước đó nếu người dùng nhấn hủy
    }
  </script>';
exit;
}
